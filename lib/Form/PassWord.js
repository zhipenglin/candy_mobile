...
var Input = (0, _field2.default)(_class = (0, _active2.default)(_class = function (_Component) {
    ...
    function Input() {
        ...
        _this.changeHandler = function (e) {
            ...
            value = value.trim();
            onChange({ computed: (0, _blueimpMd2.default)(value), origin: value });
        };
    ...
    (0, _createClass3.default)(Input, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                reset = (0, _objectWithoutProperties3.default)(_props, ['value', 'onChange']);

            return _react2.default.createElement('input', (0, _extends3.default)({ className: 'candy-mob-input', onChange: this.changeHandler, type: 'password', value: this.state.value }, reset));
        }
    }]);
    return Input;
