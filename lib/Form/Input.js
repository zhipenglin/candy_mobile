    ...
    (0, _createClass3.default)(Input, [{
        ...
        value: function render() {
            var _props4 = this.props,
                ...
                onActiveChange = _props4.onActiveChange,
                others = (0, _objectWithoutProperties3.default)(_props4, ['value', 'type', 'maxLength', 'onValueChange', 'onActiveChange']);

            if (type == 'textarea') {
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('textarea', (0, _extends3.default)({}, others, { value: value, onBlur: this.onBlurHandler, onFocus: this.onFocusHandler, onChange: this.onChangeHandler })),
            ...
            if (type == 'password') {
                return _react2.default.createElement('input', (0, _extends3.default)({ type: 'password' }, others, { value: value, onBlur: this.onBlurHandler, onFocus: this.onFocusHandler, onChange: this.onChangeHandler }));
            }
            return _react2.default.createElement('input', (0, _extends3.default)({ type: 'text' }, others, { value: value, onBlur: this.onBlurHandler, onFocus: this.onFocusHandler, onChange: this.onChangeHandler }));
        }
    }]);
    return Input;
