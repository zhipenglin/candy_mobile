...
var ListItem = (_dec = (0, _recompose.setDisplayName)('ListItem'), _dec(_class = function (_PureComponent) {
    ...
    function ListItem() {
        ...
        _this.pressMoveHandler = function (event, superEvent) {
            if (!_this.state.menuChange) {
                var x = Math.abs(superEvent.deltaX),
                    y = Math.abs(superEvent.deltaY);
    ...
    (0, _createClass3.default)(ListItem, [{
        ...
        value: function renderMenu(children) {
            ...
            if (menu && menu.length > 0) {
                ...
                return _react2.default.createElement(
                    'div',
                    { className: 'candy-mob-list_item__touch', style: this.state.open ? { zIndex: 1001 } : {} },
