    ...
    (0, _createClass3.default)(Button, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                type = _props.type,
                reset = (0, _objectWithoutProperties3.default)(_props, ['className', 'disabled', 'size', 'children', 'type']);

            (_console = console).log.apply(_console, (0, _toConsumableArray3.default)(reset));
